...
const Login = () => {
    ...
    const loginWithGoogle = useGoogleLogin({
        onSuccess: async ({ code, ...rest }) => {
            console.log("Google login successful:", rest);
            const res = await googleLogin({ code });
            if (res.success) {
                const { token, expiresIn, email, name, picture } = res.data;
                console.log({ token, expiresIn, email, name, picture });
                                ...
                                <div className="flex flex-col gap-6">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <p className="text-muted-foreground text-balance">
                                            Login to your Raise blog account
                                        </p>
                                    </div>
